...
const DetailsNews = ({ navigation, route }) => {
  ...
  const value = route.params.state;
  // console.log(value);
  ...
  const [imguri, setImgUri] = useState(0);
  ...
  // const boldContent = renderContentWithRedKeywords(
  //   item.content,
  //   item.keywordList
  // );
  return (
          ...
          <TapGestureHandler waitFor={doubleTapRef}>
            ...
            >
              <GestureRecognizer onSwipeRight={handleNext}>
                ...
                >
                  <Pressable onLongPress={() => navigation.navigate("Search")}>
                    <ViewShot
                      style={{
                        flex: 1,
                        backgroundColor: isDark
